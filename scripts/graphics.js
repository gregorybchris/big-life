...
const initGraphics = (world, onInteract, onUpdate) => {
  const canvas = d3
    .select("svg")
  ...
  canvas
    ...
    .append("rect")
    .classed("cell", true)
    .attr("x", (cell) => (cell.col - world.bounds.colMin) * cellWidth)
    .attr("y", (cell) => (cell.row - world.bounds.rowMin) * cellHeight)
    ...
    .on("click", (mouseEvent, cell) => onInteract(cell));
